...
\begin{frame}{Relativistic Velocity Addition}
    ...
    \begin{alertblock}{Interactive Relativistic Demonstrations}
        ...
        \begin{itemize}
            \item \texttt{animations/rapidity\_boost.html} \quad (Linear rapidity boosts \& additivity)
            \item \texttt{animations/01\_velocity\_saturation\_comparison.html} \quad (Velocity saturation vs classical sums)
            \item \texttt{animations/02\_spacetime\_minkowski\_diagram.html} \quad (Interactive Minkowski coordinates skewing)
        \end{itemize}
    \end{alertblock}
\end{frame}
