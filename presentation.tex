...
\begin{frame}{Collision Energetics: Why Accelerators?}
    ...
    \begin{block}{Center-of-Mass Energy Formulas}
        \begin{itemize}
            \item **Collider Advantage:** In a collider ($E_{beam1} = E_{beam2} = E$), center-of-mass energy scales linearly:
...
% Slide 5: Fixed-Target vs. Collider Geometry (Energetics comparison)
...
\begin{frame}{Relativistic Velocity Addition}
    ...
    \end{block}
    \begin{alertblock}{Interactive Relativistic Boost Simulator}
        Open \texttt{animations/rapidity\_boost.html} to interactively apply boosts and watch velocities saturate at $c$, demonstrating special relativity's universal speed limit.
    \end{alertblock}
\end{frame}
...
\begin{frame}{Proof of Rapidity Additivity}
    \begin{block}{Algebraic Derivation}
        ...
        Using the hyperbolic tangent addition identity:
        \[ \tanh(y_1 + y_2) = \frac{\tanh y_1 + \tanh y_2}{1 + \tanh y_1 \tanh y_2} \]
        We immediately obtain:
        \[ w = \tanh(y_1 + y_2) \quad \Rightarrow \quad y_{\text{tot}} = y_1 + y_2 \quad (\text{Sahoo Eq. 5.43}) \]
    \end{block}
    \begin{alertblock}{Takeaway}
        Rapidity turns non-linear velocity boosts into simple linear additions, making it the most natural variable for longitudinal collider spectroscopy.
    \end{alertblock}
\end{frame}
...
% Slide 21: Spacetime Evolution Stages of Heavy-Ion Collisions
\begin{frame}{Spacetime Evolution Stages of Heavy-Ion Collisions}
    ...
    \begin{enumerate}
        ...
        \item **Viscous Relativistic Hydrodynamics:** Strongly coupled QGP expands as a relativistic fluid ($0.5 < t < 10$ fm/c).
