...
\title[AMPT Course --- Day 3]{Day 3: Kinematics III: Transverse Spectra, Feynman Scaling, and Radial Flow}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Day 3: Kinematics III: Transverse Spectra, Feynman Scaling \& Radial Flow}
    ...
    \begin{block}{Energy Availability in Collisions}
        ...
        \begin{itemize}
            ...
            \item \textbf{Collider Configurations}:
              \[ \sqrt{s_{\mathrm{coll}}} = 2 E_{\mathrm{lab}} \]
              Two beams collide head-on. The net momentum is zero, meaning the center-of-mass frame is stationary. \textbf{All beam energy is available for particle creation}. $\sqrt{s}$ grows linearly with beam energy ($\propto E_{\mathrm{lab}}$).
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{The Feynman Scaling Variable $x_F$}
    \begin{block}{Feynman-x Definition (Sahoo Eq. 5.192)}
        \small
        The \textbf{Feynman-x variable} ($x_F$) represents the fraction of the maximum longitudinal momentum carried by a produced particle in the center-of-mass system:
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{block}{Verification with AMPT Data}
                \begin{itemize}
                    \item Plotting $\mathrm{d}N/\mathrm{d}x_F$ at $\sqrt{s_{NN}} = 7.7$ and $39$ GeV shows scaling overlap at higher $|x_F|$ values (fragmentation region).
                    \item The divergence at $x_F \approx 0$ reflects the logarithmic growth of the central rapidity plateau height as energy increases.
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
...
\begin{frame}{Collective Radial Flow: Mass-Dependent Slopes}
    \begin{block}{Extracted Temperature Superposition (Sahoo Eq. 5.222)}
...
\begin{frame}{AMPT: The Van Hove Phase Transition Signature}
    \begin{columns}
        \begin{column}{0.52\textwidth}
            \begin{center}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{block}{Observations in AMPT default model}
                \begin{itemize}
                    \item \textbf{Low multiplicity}: Rapid rise of $\langle p_T \rangle$ indicating hadronic gas warming and expanding.
                    \item \textbf{High multiplicity}: Clear flattening or plateau at $\langle p_T \rangle \approx 0.41$ GeV/c.
                \end{itemize}
            \end{block}
            \begin{block}{Do we see a Phase Transition in AMPT?}
                ...
                \begin{itemize}
                    \item However, modified versions incorporating a **Chiral Quark-Meson Model** (CQMF) or explicit first-order phase transition EoS show a distinct flat plateau in $\langle p_T \rangle$ due to latent heat absorption.
                \end{itemize}
            \end{block}
