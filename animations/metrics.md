...
This document indexes performance, responsiveness, compatibility, and complexity metrics for all **6 interactive HTML5/JS physics simulators** in this repository.
...
| **3. Lorentz Boost** | 10.2 KB | < 60ms | ✅ Yes | Plotly.js (CDN) | SVG / WebGL |
| **4. Collision Stages** | 22.5 KB | < 80ms | ✅ Yes | None (Pure JS) | HTML5 Canvas |
| **5. TPC Event Display** | 15.6 KB | < 40ms | ✅ Yes | Three.js (CDN) | WebGL (3D) |
| **6. Transverse Spectra** | 9.4 KB | < 50ms | ✅ Yes | Plotly.js (CDN) | SVG / WebGL |
...
### 3. Lorentz Boost Demonstrator (`rapidity_boost.html`)
...
### 4. Heavy-Ion Collision Stages (`collision_animation.html`)
...
### 5. TPC Event Display (`event_display.html`)
...
### 6. Transverse Spectra Builder (`pt_spectrum_builder.html`)
